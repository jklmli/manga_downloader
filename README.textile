...
Currently supports mangareader.net, with a total of over 3500 mangas.
...
* OtakuWorks won't work for a while, a new parser for the website would be too slow to be worth using since the server itself is slow.
...
Clean up code. (Extract repetitive code and put into single method)
