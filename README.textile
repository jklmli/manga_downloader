...
* Downloading works on MangaReader, but can't grab max number of chapters (or even series homepage) due to urls with some hashed number - can fix by piping through bing search...
* Considering pulling Animea out for now
