...
Options:
  ...
  -d DOWNLOAD_PATH, --directory=DOWNLOAD_PATH
                        The destination download directory.  Defaults to
                        current working directory.
  --overwrite           Overwrites previous copies of downloaded chapters.
  -s, --subdirectory    Creates a new subdirectory inside the current working
                        directory using the name of the manga.
  -x XMLFILE_PATH, --xml=XMLFILE_PATH
                        Parses the .xml file and downloads all chapters newer
                        than the last chapter downloaded for the listed
                        mangas.
  -z, --zip             Downloads using .zip compression.  Omitting this
                        option defaults to .cbz.
