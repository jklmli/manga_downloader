...
*v0.5.1* (11/3/10)
+ Modified the parse Manga Reader to find all entries returned by the search query instead of just the first one. The other two parse functions already work this way.  
