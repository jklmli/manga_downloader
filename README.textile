...
* Program does not handle an empty node for LastChapterDownloaded. If the node is empty, the scripts 
* fails to update it. Thus all the chapters are downloaded each time the script is run.
