...
It can be backported by changing the exception-handling code, and removing parentheses after class declarations, but these changes will break compatibility with Python 3.
