...
* MangaVolume almost 5X faster than Animea without a hitch on same connection - maybe Animea is less flaky-connection-tolerant?
* Downloading works on MangaReader, but can't grab max number of chapters (or even series homepage) due to urls with some hashed number?
* MangaVolume doesn't carry any big-name mangas...really need to fix Animea/MangaReader
...
Add support for mangareader.net
