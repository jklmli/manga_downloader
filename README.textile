...
@-s, --subdirectory@
Sets download directory to a subdirectory inside the current working directory using the name of the manga.
...
* Due to zero-padding, all numerals are left-padded to 3 digits.  This includes manga/chapter titles.
...
+ Applied 3-digit zero-padding to all sites, this restores chapter skipping for MangaReader.  However, see 'Issues.'
